...
export class Obj3D{
   ...
   ze: number = 0; 
   objSize: number = 0;
   private imgCenter: Point2D | undefined;
   private sunZ: number = 1 / Math.sqrt(3); 
   sunY: number = this.sunZ; 
   sunX: number = -this.sunZ;
   inprodMin: number = 1e30; 
   inprodMax: number = -1e30; 
   inprodRange: number = 0;
   ...
   getImgCenter():Point2D | undefined {return this.imgCenter;}
